...
<style>
    ...
    .vs { font-weight: bold; color: #888; padding: 0 15px; font-size: 0.9em; }
    .pred-badge {
        font-weight: bold; padding: 6px 14px; border-radius: 6px; color: white;
    ...
    .status-badge {
        font-size: 0.7em; padding: 2px 8px; border-radius: 4px; margin-left: 5px; text-transform: uppercase;
    }
    ...
    .prob-container { display: flex; margin-top: 15px; height: 10px; border-radius: 5px; overflow: hidden; width: 100%; background-color: #444; }
    .prob-segment { height: 100%; }
    .prob-labels { display: flex; justify-content: space-between; font-size: 0.8em; color: #bbb; margin-top: 6px; font-family: monospace; }
</style>
